...
echo "o64-clang++ -shared -o bin/mac64/libGDSerial.dylib bin/obj/*.o godot-cpp/bin/libgodot-cpp.osx.release.x86_64.a serial/build/mac64/libserial.a -framework Foundation -framework IOKit"
o64-clang++ -shared -o bin/mac64/libGDSerial.dylib bin/obj/*.o godot-cpp/bin/libgodot-cpp.osx.release.x86_64.a serial/build/mac64/libserial.a -framework Foundation -framework IOKit
rm -r bin/obj